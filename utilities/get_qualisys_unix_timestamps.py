...
def get_qualisys_unix_timestamps(qualisys_df: pd.DataFrame,
    ...
    seconds_added_to_qualisys_timestamps_to_align_with_pupil = 80  # TODO Figure out the hard coded offset for this dataset.

    qualisys_start_time_unix = qualisys_start_time_unix_local_time + time_zone_offset_in_seconds + \
                               seconds_added_to_qualisys_timestamps_to_align_with_pupil
